...
public class RateExcelContractBatchDaoImpl extends HibernateDaoSupport implements ExcelBatchDaoDelegate {
	...
	public void insertInventoryTemporary(List<Map<String,String>> dataList,List<String> columnList,String batchNo) throws SQLException{
		StringBuffer insertSb = new StringBuffer("insert into rate_contact_length_import (`rate_id`  ," +
					"`summary_vendor_name`," +
					"`charge_type`," +
					"`key_field`," +
					"`usoc`," +
...
//				stmt.executeUpdate();
	...
	public void callInventoryVerification(String batchNo) throws SQLException{
		...
		try {
			...
			proc = con.prepareCall("call SP_RATE_CONTACT_VERIFICATION('"+batchNo+"')");
			proc.execute();
