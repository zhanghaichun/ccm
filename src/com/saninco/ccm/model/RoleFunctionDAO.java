 ...
 * RoleFunction entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see com.saninco.ccm.model.RoleFunction
 * @author MyEclipse Persistence Tools
 */

public class RoleFunctionDAO extends HibernateDaoSupport {
	private static final Log log = LogFactory.getLog(RoleFunctionDAO.class);
	// property constants
	...
	public RoleFunction findById(java.lang.Integer id) {
		...
		try {
			RoleFunction instance = (RoleFunction) getHibernateTemplate().get(
					"com.saninco.ccm.model.RoleFunction", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public RoleFunction merge(RoleFunction detachedInstance) {
		...
		try {
			RoleFunction result = (RoleFunction) getHibernateTemplate().merge(
					detachedInstance);
	...
	public static RoleFunctionDAO getFromApplicationContext(
			ApplicationContext ctx) {
		return (RoleFunctionDAO) ctx.getBean("RoleFunctionDAO");
	}
}