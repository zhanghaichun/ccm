 ...
 * 
 * @see com.saninco.ccm.model.ItemType
 * @author MyEclipse Persistence Tools
 */

public class ItemTypeDAO extends HibernateDaoSupport {
	...
	public ItemType findById(java.lang.Integer id) {
		...
		try {
			ItemType instance = (ItemType) getHibernateTemplate().get(
					"com.saninco.ccm.model.ItemType", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public ItemType merge(ItemType detachedInstance) {
		...
		try {
			ItemType result = (ItemType) getHibernateTemplate().merge(
					detachedInstance);
	...
	public static ItemTypeDAO getFromApplicationContext(ApplicationContext ctx) {
		return (ItemTypeDAO) ctx.getBean("ItemTypeDAO");
	}
}