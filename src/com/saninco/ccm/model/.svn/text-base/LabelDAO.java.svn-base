 ...
 * 
 * @see com.saninco.ccm.model.Label
 * @author MyEclipse Persistence Tools
 */

public class LabelDAO extends HibernateDaoSupport {
	...
	public List findByIconFilePath(Object iconFilePath) {
		return findByProperty(ICON_FILE_PATH, iconFilePath);
	}
