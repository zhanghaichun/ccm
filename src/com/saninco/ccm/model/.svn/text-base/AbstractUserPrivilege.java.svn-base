...
public abstract class AbstractUserPrivilege implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractUserPrivilege() {
	}

	/** full constructor */
	public AbstractUserPrivilege(Vendor vendor, Ban ban,
