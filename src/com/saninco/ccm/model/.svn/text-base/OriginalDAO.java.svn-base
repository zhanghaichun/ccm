 ...
 * 
 * @see com.saninco.ccm.model.Original
 * @author MyEclipse Persistence Tools
 */

public class OriginalDAO extends HibernateDaoSupport {
	private static final Log log = LogFactory.getLog(OriginalDAO.class);
	// property constants
	...
	public Original findById(java.lang.Integer id) {
		...
		try {
			Original instance = (Original) getHibernateTemplate().get(
					"com.saninco.ccm.model.Original", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Original instance) {
	...
	public Original merge(Original detachedInstance) {
		...
		try {
			Original result = (Original) getHibernateTemplate().merge(
					detachedInstance);
