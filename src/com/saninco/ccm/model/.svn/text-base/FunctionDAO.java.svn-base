 ...
 * 
 * @see com.saninco.ccm.model.Function
...
public class FunctionDAO extends HibernateDaoSupport {
	...
	public static final String FUNCTION_ACTIVE_FLAG = "functionActiveFlag";
	...
	public Function findById(java.lang.Integer id) {
	...
	public List findByFunctionActiveFlag(Object functionActiveFlag) {
		return findByProperty(FUNCTION_ACTIVE_FLAG, functionActiveFlag);
	}
