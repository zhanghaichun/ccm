 ...
 * 
 * @see com.saninco.ccm.model.Payment
...
public class PaymentDAO extends HibernateDaoSupport {
	...
	// property constants
	public static final String PAYMENT_TRANSACTION_NUMBER = "paymentTransactionNumber";
	...
	public static final String RECEIVED_PAYMENT_ID = "receivedPaymentId";
	public static final String HIST_PAYMENT_ID = "histPaymentId";
	...
	public List findByPaymentTransactionNumber(Object paymentTransactionNumber) {
		return findByProperty(PAYMENT_TRANSACTION_NUMBER,
	...
	public List findByReceivedPaymentId(Object receivedPaymentId) {
		return findByProperty(RECEIVED_PAYMENT_ID, receivedPaymentId);
	}

	public List findByHistPaymentId(Object histPaymentId) {
		return findByProperty(HIST_PAYMENT_ID, histPaymentId);
	}
