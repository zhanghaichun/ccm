...
<script type="text/javascript"
	src="include/javascript/ccm/masterInventory/inventoryRatePage.js"></script>
<script type="text/javascript"
	src="include/javascript/ccm/masterInventory/masterInventoryRateChangeHistory.js"></script>
<link rel="stylesheet"
	...
	<div style="border-top: 0px none;">
		<s:form id="form0" action="searchMasterInventoryList.action"
			...
			<table class="tabDetailView" border=" 0" width="100%" cellpadding="5"
				cellspacing="0">
				<tr>
					<td class="tabDetailViewDL searchItemPanel">
			...
			<tr>
				<td>
					...
					<input id="download_button" type="button" value="Download to Excel"
						onclick="saveMasterInventoryRateToExcel();" />
				</td>
				<tr>
		</table>
	</div>
				...
				<tr>
					<td>
						...
						<input id="download_button" type="button"
							...
							onclick="changeHistory.saveInventoryRateChangeHistoryToExcel();" />
					</td>
					<tr>
			</table>
		</div>
		...
		<div class="miDetailDiv" style="overflow: auto; height: 550px">
			<table class="miDetailTable">
				...
				<tr>
					...
					<td align="left"
						style="position: relative; height: 25px; width: 260px" colspan="2">
						<!--  <input id="detail_expiry_date" cssClass="validate-date-ca"
							cssStyle="width:165px"></input> -->
						<input id="detail_expiry_date" 
						cssClass="validate-date-ca" style="width:152px;"/>
						<a onClick="selectDate()"><img
				...
				<tr>
					...
					<td align="left"
						style="position: relative; height: 25px; width: 260px" colspan="2">
						<input id="detail_last_signoff_date" cssClass="validate-date-ca" 
							cssStyle="width:165px"></input>
						yyyy/mm/dd
					</td>
					<td style="white-space: nowrap; width: 150px;">
					...
					<td align="left"
						style="position: relative; height: 25px; width: 260px" colspan="2">
						<input id="detail_multiplier" cssClass="validate-number" 
							cssStyle="width:240px" onkeyup="clearNoNum(this)"></input>
					</td>
				</tr>
				<tr>
					<td style="white-space: nowrap; width: 150px;">
					...
					<td align="left"
						style="position: relative; height: 25px; width: 260px" colspan="2">
						<input id="detail_rate" cssClass="validate-number" 
							cssStyle="width:240px" onkeyup="clearNoNum(this)"></input>
					</td>
				</tr>
				<tr>
					...
					<td align="left"
						style="position: relative; height: 25px; width: 260px" colspan="2">
						<input id="detail_rate_effective_date" cssClass="validate-date-ca" 
							cssStyle="width:165px"></input>
						yyyy/mm/dd
					</td>
					<td style="white-space: nowrap; width: 150px;">
					...
					<td align="left"
						style="position: relative; height: 25px; width: 260px" colspan="2">
						<s:textfield id="detail_circuit_term" cssClass="validate-alp" 
							cssStyle="width:240px" maxlength="32"></s:textfield>
					</td>
				</tr>
				<tr>
					...
					<td align="left"
						style="position: relative; height: 25px; width: 260px" colspan="2">
						<s:textfield id="detail_contract" cssClass="validate-alp" 
							cssStyle="width:240px" maxlength="128"></s:textfield>
					</td>
					<td style="white-space: nowrap; width: 150px;">
						Tariff
					...
					<td align="left"
						style="position: relative; height: 25px; width: 260px" colspan="2">
						<s:textfield id="detail_tariff" cssClass="disabled-style" 
							cssStyle="width:240px" readonly="true"></s:textfield>
					</td>
				</tr>
				<tr>
					...
					<td align="left"
						style="position: relative; height: 25px; width: 260px" colspan="2">
						<s:textfield id="detail_tariff_page" 
							cssClass="validate-alp" cssStyle="width:240px" maxlength="256"></s:textfield>
					</td>
				...
				<tr>
					...
					<td align="left"
						style="position: relative; height: 25px; width: 260px" colspan="2">
						<s:textfield id="detail_rate_status" cssClass="validate-alp" 
							cssStyle="width:240px" maxlength="128"></s:textfield>
					</td>
					...
					<td align="left"
						style="position: relative; height: 25px; width: 260px" colspan="2">
						<s:textfield id="detail_agreement_type" cssClass="disabled-style" 
							cssStyle="width:240px" readonly="true"></s:textfield>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="left"
						style="position: relative; height: 25px; width: 260px" colspan="2">
						<s:textfield id="detail_rate_discrepancy" 
							cssClass="disabled-style" cssStyle="width:240px" readonly="true"></s:textfield>
					</td>
